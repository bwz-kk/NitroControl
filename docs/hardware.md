...
- **No persistent config or udev rule installed this session** — unlike FR-007's M5 follow-up, this pass stopped at live verification; a `docs/optional-setup.md` section for a battery-limit-specific udev rule is a separate, not-yet-made decision.
