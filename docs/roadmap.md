...
- 25 new tests (21 `nitroctl-core` provider tests, 1 `AcerNitroV15` delegation test, 4 `redact_evidence` unit tests, 3 `nitroctl-cli` diagnose tests) — 191/191 workspace tests, clippy/fmt clean.
